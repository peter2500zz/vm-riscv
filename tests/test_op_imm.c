...
int main(void) {
        ...
        // slti x1, x2, 100
        vm_exec(vm, 0x06412093);
        ASSERT_EQ(vm->_regs[1], 1);

        // slti x1, x2, 25
        vm_exec(vm, 0x01912093);
        ASSERT_EQ(vm->_regs[1], 0);

        // slti x1, x2, 50
        vm_exec(vm, 0x03212093);
        ASSERT_EQ(vm->_regs[1], 0);
        ...
        // slti x1, x2, -75
        vm_exec(vm, 0xfb512093);
        ASSERT_EQ(vm->_regs[1], 0);

        // slti x1, x2, 0
        vm_exec(vm, 0x00012093);
        ASSERT_EQ(vm->_regs[1], 0);
        ...
        // sltiu x1, x2, 100
        vm_exec(vm, 0x06413093);
        ASSERT_EQ(vm->_regs[1], 1);

        // sltiu x1, x2, 25
        vm_exec(vm, 0x01913093);
        ASSERT_EQ(vm->_regs[1], 0);

        // sltiu x1, x2, 50
        vm_exec(vm, 0x03213093);
        ASSERT_EQ(vm->_regs[1], 0);
        ...
        // sltiu x1, x2, -75
        vm_exec(vm, 0xfb513093);
        ASSERT_EQ(vm->_regs[1], 1);

        // sltiu x1, x2, 0
        vm_exec(vm, 0x00013093);
        ASSERT_EQ(vm->_regs[1], 0);
        ...
        // xori x1, x2, 1750
        vm_exec(vm, 0x6d614093);
        ASSERT_EQ(vm->_regs[1], 0xDEADB839);

        // xori x1, x2, -799
        vm_exec(vm, 0xce114093);
        ...
        // ori x1, x2, 1750
        vm_exec(vm, 0x6d616093);
        ASSERT_EQ(vm->_regs[1], 0xDEADBEFF);

        // ori x1, x2, -799
        vm_exec(vm, 0xce116093);
        ...
        // andi x1, x2, 1750
        vm_exec(vm, 0x6d617093);
        ASSERT_EQ(vm->_regs[1], 0x6C6);

        // andi x1, x2, -799
        vm_exec(vm, 0xce117093);
